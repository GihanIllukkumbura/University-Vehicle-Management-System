...
class NewSettingTrip extends StatefulWidget {
  final String selectedVehicleId;
  final String selectedVehicleName;
  final String selectedVehicledpkm;

  const NewSettingTrip({
    Key? key,
    required this.selectedVehicleId,
    required this.selectedVehicleName,
    required this.selectedVehicledpkm,
...
class _MapWidgetState extends State<NewSettingTrip> {
  ...
  _confirmTrip() async {
    ...
    try {
      ...
      // Fetch the dpkm value for the selected vehicle from Firestore
      ...
      Map<String, dynamic> tripData = {
        ...
        'vehicleName': widget.selectedVehicleName, // Add selectedVehicleName from widget
        'tripstatus': 0,
        'dpkm': widget.selectedVehicledpkm,
        //'estimatedFuelConsumption': estimatedFuelConsumption, // Add estimated fuel consumption
